...
class TestSelectData(unittest.TestCase):
    def test_select_data_returns_expected_type(self):
    ...
    def test_select_data_returns_single_object(self):
    ...
    def test_select_data_returns_selection_from_input_args(
        self,
    ):
    ...
    def test_select_data_with_weights_that_do_not_sum_to_1_(
        self,
    ):
    ...
    def test_select_data_with_invalid_weight_types(self):
    ...
    def test_select_data_with_different_length_args(self):
