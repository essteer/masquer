...
class TestGetResponse(unittest.TestCase):
    def test_get_response_returns_expected_header_data_output(self):
    ...
    def test_get_response_returns_expected_referer_output(self):
    ...
    def test_get_response_returns_expected_useragents_output(self):
    ...
    def test_get_response_makes_function_call_with_expected_referer_args(
        self, mock_choices
    ):
    ...
    @patch("random.choices")
    def test_get_response_makes_function_call_with_expected_useragent_args(
        self, mock_choices
    ):
